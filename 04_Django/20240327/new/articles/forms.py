...
#     # 적절한 Field들을 내가 직접 작성해 줘야 한다.
#     '''
#         HTML에서 슬 form 태그를 구성해주는 class인데...
#         field에 대한 정보가 없으면...? input tag 뭘 써야 할지 알수가 없다
#         그래서... 그 field들 내가 정의한다.
#         정의하는 방법은? django Model 정의하는 거랑 똑같다.
#     '''
