...
-- 새 테이블을 생성하고 total_amount 컬럼을 제외한 열을 복사합니다.
CREATE TABLE temp_orders AS
SELECT order_id, order_date, customer_id, price
FROM orders;

-- 기존 테이블을 삭제합니다.
DROP TABLE orders;

-- 새 테이블의 이름을 기존 테이블 이름으로 변경합니다.
ALTER TABLE temp_orders RENAME TO orders;

INSERT INTO orders (order_id, order_date, customer_id, price) VALUES
    (1, '2023-07-15', 1, 50),      -- 2023년 7월 15일 주문, 총 주문 금액: 50.99
    (2, '2023-07-16', 2, 75),      -- 2023년 7월 16일 주문, 총 주문 금액: 75.50
    (3, '2023-07-17', 3, 30);
